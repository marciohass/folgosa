            ...
            <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="{{route('assinaturas.store')}}" method="post" enctype="multipart/form-data">
                      <div class="card-body">
                        @if ($errors->any())
                        ...
                        <div class="form-group col-sm-12">
                          ...
                          <input type="text" name="nome" class="form-control" id="nome" placeholder="Título" required>
                        </div>
                        <div class="form-group col-sm-12">
