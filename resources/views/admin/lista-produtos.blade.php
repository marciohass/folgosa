          ...
          <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-10">
                            <h3 class="card-title mb-0">Listagem de produtos</h3>
                        </div>
                        <div class="col-sm-2">
                            <a class="btn btn-primary btn-sm" href="{{ route('admin.form-produtos') }}" role="button">Adicionar</a>
                        </div>
                    </div>
                </div>
                <!-- /.card-header -->
                            ...
                            <div class="col-sm-12">
                                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">Promoção</th>
                                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending">Novidade</th>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td width="10%">
                                                    <form action="{{ route('produtos.destroy', $item->id) }}" method="post">
                                                        <a href="{{ route('admin.form-edit-produtos',$item->id)}}" class="btn btn-primary btn-sm" data-placement="top"><i class="fas fa-edit"></i></a>
                                                        @csrf
                                                        @method('DELETE')
